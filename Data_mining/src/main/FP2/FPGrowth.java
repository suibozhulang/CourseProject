...
public class FPGrowth {
	...
	public void printFPatterns(){
		...
		System.out.println("size:"+FPatterns.size());
	}
	...
	public static void main(String[] args) {
		...
		//txt
		FPGrowth fpGrowth = new FPGrowth("./src/main/resources/FP_test.dat",0.2);
		//data
		//FPGrowth fpGrowth = new FPGrowth("D:\\JAVA\\my javas\\Algorithms\\apriori\\src\\frequent_Pattern_Mining\\adult.data", 0.6);
		fpGrowth.doit();
